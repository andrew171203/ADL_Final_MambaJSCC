...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, out_dim, input_resolution, depth, num_heads, window_size,
        ...
        #     LegacySwinTransformerBlock(dim=dim, input_resolution=input_resolution,
...
class VSSBJSCC_Decoder(nn.Module):
...
SwinJSCC_Decoder = VSSBJSCC_Decoder
